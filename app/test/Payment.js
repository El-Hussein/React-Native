      ...
      <ScrollView>
        <ImageBackground source={new_back} style={{flex:1, resizeMethod:"contain"}} >
          ...
          <View style={{ height:hp('16%')}}>
                <ImageBackground source={header_bg} style={{flex:1, resizeMethod:"contain", justifyContent:'space-evenly', alignContent:'center'}} >
                    ...
                    <View style={{flexDirection:'row', paddingHorizontal:wp('4%'), justifyContent:'space-between', alignItems:'center'}}>
                        ...
                        <View style={{backgroundColor:'#03507E', paddingVertical:wp('0%'), paddingHorizontal:wp('1%'), justifyContent:'center', alignItems:'center', borderRadius:wp('1%')}}>
                            <Text style={{color:'white', fontWeight:'bold', fontSize:wp('4.5%')}}>Payment</Text>
                        </View>
                        <View style={{backgroundColor:'white', paddingVertical:wp('0%'), paddingHorizontal:wp('1%'), justifyContent:'center', alignItems:'center', borderRadius:wp('1%')}}>
            ...
            <View>
                <View style={{flexDirection:'row', alignItems:'center', height:hp('5%'), justifyContent:'space-between', marginHorizontal:wp("2%")}}>
                    <Text style={{color:"#5D6164", fontSize:wp('4%'), fontWeight:"bold"}}> USE A VOUCHER </Text>
                </View>
            </View>

             <View>
                <View style={{flexDirection:'row', alignItems:'center', backgroundColor:'white', padding:wp('2%'), justifyContent:'space-between', marginHorizontal:wp("2%")}}>
                    <TextInput
                        style={{height: wp('9%'), backgroundColor: '#B4B4B4', borderRadius:wp('2%'), width:wp('76.5%'), color:'white', padding:0, paddingLeft:wp('2%')}}
                        onChangeText={(text) => this.setState({text})}
                        value={this.state.text}
                    />
                    <TouchableOpacity>
                        <Text style={{color:"white", fontSize:wp('4%'), fontWeight:"700", backgroundColor:'#095380', borderRadius:wp('1%'), paddingVertical:wp('2%')}}> APPLY </Text>
                    </TouchableOpacity>
                </View>
            </View>
            ...
            <View>
                <TouchableOpacity style={{borderRadius:wp('1.5%'), justifyContent:'center', alignItems:'center', padding:wp('2%')}}>
                    <Text style={{color:'white', fontWeight:'bold', backgroundColor:'#055381', paddingHorizontal:wp('10%'), fontSize:wp('5%'), borderRadius:wp('1%'), padding:wp('1%')}}>PROCEED TO SUMMARY</Text>
                </TouchableOpacity>
            </View>
        </ImageBackground> 
        </ScrollView>
