    ...
    render () {
         ...
         return (
             <ImageBackground source={backGround} style={{flex:1}}>
                <Image source={logo} style={{width:wp('68%'), height:hp('10.4%'), position:'absolute', top:hp('1.8%'), left:DW/6}}/>

                <View style={{paddingHorizontal:wp('2%'), height:hp('32%'), marginTop: 2*DH/10}}>
