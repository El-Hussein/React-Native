...
class Wallpaper extends Component {
  ...
  back(){
    // alert("come from back 2 going to home");
  ...
  _signIn (){
      try {
        ...
        GoogleSignin.signIn().then((userInfo)=>{
          ...
          // this.props.navigation.navigate('UserProfile', {BACK2:()=>this.back()});
        });
      } catch (error) {
  ...
  render() {
      ...
      return (
        <ImageBackground style={styles.picture} source={bgSrc} >
          <View style={{padding:20 , alignItems:'flex-start'}}>
              <TouchableOpacity onPress={()=>this.props.navigation.navigate('Home', {BACK2:()=>this.back()})}>
    ...
    if(user.user){
      return (
        <ImageBackground style={styles.picture} source={bgSrc} >
          <View style={{padding:20 , alignItems:'flex-start'}}>
              <TouchableOpacity onPress={()=>{this.back(); this.props.navigation.navigate('Home')}}>
                <Icon name="keyboard-backspace" size={30} color="white"/>
              </TouchableOpacity>
            </View>
          <View style={styles.splashContainer}>
...
class AuthinticationComponent extends Component {
    render(){
      return(
        <AuthNavigator {...this.props}/>
      )
    }
}

// export default connect(mapStateToProps, { loginUser })(AuthinticationComponent);
export default AuthinticationComponent;
